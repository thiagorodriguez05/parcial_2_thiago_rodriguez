...
from ZZZ_colores import color_gris_claro
...
class nivelDos(Nivel):
    def __init__(self, pantalla: pygame.surface) -> None:
        fondo = pygame.image.load("assets/img/niveles/lvl_2.png")
        ...
        plataforma_cinco = Plataformas("assets\img\platafromas\plataforma_1.png",(0, 275), (300,75), (509, 193))
        plataforma_seis = Plataformas("assets\img\platafromas\plataforma_1.png",(0, 500), (150,75), (509, 193))
        plataforma_siete = Plataformas("assets\img\platafromas\plataforma_1.png",(1350, 250), (150,75), (509, 193))
        
        lista_plataformas_uno = [plataforma_uno, plataforma_dos, plataforma_tres, plataforma_cuatro, plataforma_cinco, plataforma_seis, plataforma_siete]
        
        lista_gravedad_uno = [piso.lados["top"], plataforma_uno.lados["top"], plataforma_dos.lados["top"],plataforma_tres.lados["top"], 
                            plataforma_cuatro.lados["top"], plataforma_cinco.lados["top"], plataforma_seis.lados["top"], plataforma_siete.lados["top"]]
        ...
        llave_nivel_uno = Elementos(animaciones_llave, (20, 200), (60, 60))
        lista_llave_uno = [llave_nivel_uno]
        
        flor_trampa_uno = Trampas((100, 30), (141, 215), (80,80))
        
        listas_trampas = [flor_trampa_uno]
        
        puerta_nivel_uno = Puerta(diccionario_puerta, (1370, 125))
        ...
        super().__init__(pantalla, fondo, mi_personaje, lista_plataformas_uno, lista_gravedad_uno, 
                        ...
                        puerta_nivel_uno, None, False,  False, None, color_gris_claro)
